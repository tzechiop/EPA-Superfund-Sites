...
maindir = r'C:\Users\thasegawa\Documents\68 NYC DEP Papers\05 Data\Newtown Creek\Bootstrap Surface Sediments'
fname = 'Surface Sediment Bootstrapping Data.xlsx'
sheetname = 'Bootstrapping'
...
chem_cols = ['TPAH (SIM For Ph1&2 NTC and Ref Area, Not Sure About Gowanus, Non-SIM for GPEC) mg/kg',
             'LMW 7 PAH (SIM For Ph1&2 NTC and Ref Area, Not Sure About Gowanus, Non-SIM for GPEC) mg/kg',
             'HMW 10 PAH (SIM For Ph1&2 NTC and Ref Area, Not Sure About Gowanus, Non-SIM for GPEC) mg/kg',
             'TPCB mg/kg',
             'Copper mg/kg',
             'Lead mg/kg']
...
percentiles_all.to_excel('GW_Bootstrap_Bootstrapped_20160901.xlsx')
